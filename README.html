...
<html>
    ...
    <body>
		<header>
			<nav id="navbar">
				<div class="container">
					...
					<h1 class="logo"><a href="index.htm">Groups</a></h1>
					<ul>
		...
		<div class="main-body">
			...
			<p>Welcome to the private group chatting</p>
		</div>
		<div class="btn">
			
			<input class="signin" type="button" onclick="alert('No any Account found in database!')" value="SignIn">
			<input class="signin" type="button" onclick="alert('You are not allowed to SignUp!')" value="SignUp">
